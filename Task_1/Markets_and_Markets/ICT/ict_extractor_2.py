...
df = pd.read_csv('ict_helper_file.csv')
        ...
        for tags in rel_tags:
            ...
            if(got_table):
                ...
                if(indicator_symbol == 'h2'):
                    table_h2_tags = tags
                    if((('target' in table_h2_tags.text.split()) or \
            ...
            if(indicator_symbol == 'ta'):
                ...
                if((len(table_h2_tags)>0) and (('target' in table_h2_tags[-1].split()) or \
                    ('Target' in table_h2_tags[-1].split()) or ('Audience' in table_h2_tags[-1].split()))):
                    got_target_audience = True;
                got_table = True
...
#links = ['https://www.marketsandmarkets.com/Market-Reports/seaweed-protein-market-194056009.html']
